...
puts ("Chapter 4: Variables and Assignment" + "page 17".rjust(line_width/2))
puts ("Chapter 5: Mixing It Up" + "page 21".rjust(line_width/2))
puts ("Chapter 6: More About Methods" + "page 27".rjust(line_width/2))
